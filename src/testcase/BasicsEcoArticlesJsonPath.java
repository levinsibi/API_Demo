...
public class BasicsEcoArticlesJsonPath {
	...
	public static void main(String[] args) {
		...
		String response = given().log().all().header("Content-Type", "application/json").when()
				.get("api/v1/drives/articles?locale=en-US").then().assertThat().statusCode(200).extract().response()
				.asString();
